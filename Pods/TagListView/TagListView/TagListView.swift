...
open class TagListView: UIView {
    ...
    private func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            tagView.subviews.last?.frame = CGRect(x: (tagView.frame.size.width-(UIImage(named: "tick_filled")?.size.width)!)/2, y: (tagView.frame.size.height-(UIImage(named: "tick_filled")?.size.height)!)/2, width: (UIImage(named: "tick_filled")?.size.width)!, height: (UIImage(named: "tick_filled")?.size.height)!)
    ...
    private func createNewTagView(_ title: String) -> TagView {
        ...
        let selectedIcon = UIImageView(frame: CGRect(x: (tagView.frame.size.width-(UIImage(named: "tick_filled")?.size.width)!)/2, y: (tagView.frame.size.height-(UIImage(named: "tick_filled")?.size.height)!)/2, width: (UIImage(named: "tick_filled")?.size.width)!, height: (UIImage(named: "tick_filled")?.size.height)!))
        selectedIcon.image = UIImage(named: "tick_filled")
        selectedIcon.isHidden = true
        tagView.addSubview(selectedIcon)
