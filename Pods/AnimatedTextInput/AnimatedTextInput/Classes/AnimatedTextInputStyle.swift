...
public struct AnimatedTextInputStyleBlue: AnimatedTextInputStyle {
    ...
    public let activeColor = UIColor.lightGray//UIColor(red: 51.0/255.0, green: 175.0/255.0, blue: 236.0/255.0, alpha: 1.0)
    public let inactiveColor = UIColor.lightGray//UIColor.gray.withAlphaComponent(0.5)
    public let lineInactiveColor = UIColor.clear//UIColor.gray.withAlphaComponent(0.2)
    public let errorColor = UIColor.red
    public let textInputFont = UIFont.systemFont(ofSize: 15)
    public let textInputFontColor = UIColor.darkGray
